...
#SBATCH --gres=gpu:rtx8000:3 #gpu:h100:2 #gpu:a100:8 #gpu:rtx8000:3 #gpu:a100:8 #gpu:h100:2 #gpu:l40s:4 #gpu:a100:8  #gpu:h100:2 #gpu:rtx8000:3 #gpu:a40:3 #gpu:rtx8000:3 #gpu:a100:8 #gpu:h100:2 #gpu:l40s:4 #gpu:a100:8  #gpu:h100:2 #gpu:a100:8                       # GPU request
#SBATCH --job-name=make_test_data                  # Job name
