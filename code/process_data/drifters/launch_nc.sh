...
#SBATCH --gres=gpu:a100:1  #gpu:rtx8000:3 #gpu:h100:2 #gpu:rtx8000:3 #gpu:l40s:4 #gpu:h100:2 #gpu:a100:8                       # GPU request
#SBATCH --job-name=convert_nc                        # Job name
...
srun python convert_pyo_to_nc_cmems_0m.py