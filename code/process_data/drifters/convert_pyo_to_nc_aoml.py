...
for year in range(2023,2025):
    print(year)
    ifile = f"/Odyssey/private/t22picar/data/drifters/AOML/Drifters_AOML_GL_15m_{year}0101T000000Z_{year+1}0101T000000Z.pyo.gz"
    ...
    for ide, odic in dic_pyo.items():
        ...
        ofile = os.path.join('/Odyssey/public/drifters/aoml/', f'drifter_{ide}_{year}.nc')
