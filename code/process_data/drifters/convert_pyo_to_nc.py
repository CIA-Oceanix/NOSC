...
for year in range(2010,2025):
    ifile = f"/Odyssey/private/t22picar/data/drifters/CMEMS/Drifters_CMEMS_GL_15m_{year}0101T000000Z_{year+1}0101T000000Z.pyo.gz"
    ...
    for ide, odic in dic_pyo.items():
        ...
        ofile = os.path.join('/Odyssey/public/drifters/cmems/', f'drifter_{ide}_{year}.nc')
