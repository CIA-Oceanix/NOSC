...
for year in range(2010,2024):
    print(year)
    ifile = f"/Odyssey/private/t22picar/data/drifters/drifter_00m/AOML_GL_00/Drifters_AOML_GL_00m_{year}0101T000000Z_{year+1}0101T000000Z.pyo.gz"
    ...
    for ide, odic in dic_pyo.items():
        ...
        ofile = os.path.join('/Odyssey/public/drifters/aoml_00m/', f'drifter_{ide}_{year}.nc')
