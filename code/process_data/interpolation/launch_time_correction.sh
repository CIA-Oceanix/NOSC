...
#SBATCH --gres=gpu:a100:1 #gpu:rtx8000:1 #gpu:a100:8 #gpu:h100:2 #gpu:l40s:4 #gpu:a100:8  #gpu:h100:2 #gpu:rtx8000:3 #gpu:a40:3 #gpu:rtx8000:3 #gpu:a100:8 #gpu:h100:2 #gpu:l40s:4 #gpu:a100:8  #gpu:h100:2 #gpu:a100:8                       # GPU request
#SBATCH --job-name=time_era5              # Job name
...
srun python time_float_to_datetime.py